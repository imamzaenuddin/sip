		...
		<div class="col-xs-12">
			...
			<form class="form-horizontal" role="form">
				...
				<div class="form-group">
					<label class="col-sm-3 control-label no-padding-right" for="form-field-1"> Jenis Surat ID </label>

					<div class="col-sm-9">
						<input type="text" id="form-field-1" placeholder="Jenis Surat ID" class="col-xs-10 col-sm-5" />
					</div>
				</div>
