		...
		<div class="col-xs-12">				
			...
			<form class="form-horizontal" role="form">
				...
				<div class="form-group">
					<label class="col-sm-3 control-label no-padding-right" for="form-field-1"> Level ID </label>

					<div class="col-sm-9">
						<input type="text" name="LevelID" id="form-field-1" placeholder="LevelID" class="col-xs-10 col-sm-5" />
					</div>
				</div>
